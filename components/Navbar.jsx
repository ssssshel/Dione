...
const Navbar = () => {
  ...
  return ( 
    <div>
      <div id="navbar" className="fixed z-10 w-full h-20 px-5 rounded-b-3xl backdrop-blur-md lg:hidden xl:hidden 2xl:hidden bg-purple/30 ">
      ...
      <div className="fixed z-10 w-full h-auto px-14 bg-purple/30 backdrop-blur-md sm:hidden md:hidden">
        ...
        <div className="flex flex-row items-center justify-between">
          ...
          <div>
            <ul className="flex flex-row items-center gap-16">
              <li>
                <Link href="/">
                  <a className="text-lg hover:text-bluebell text-lavander">Inicio</a>
                </Link>
              </li>
              <li className="text-lg cursor-pointer hover:text-bluebell text-lavander" id="system" onMouseOver={dropDown}>
                Sistema
              </li>
              <li className="flex flex-col justify-center w-24 ">
                <Link href="/">
                  <a className="flex flex-col justify-center h-20 text-lg text-center transition duration-150 ease-in-out bg-xiketic hover:scale-110 hover:bg-purple hover:text-bluebell text-lavander">Buscar</a>
                </Link>
              </li>
              <li>
                <Link href="/">
                  <a className="text-lg hover:text-bluebell text-lavander">Acerca de</a>
                </Link>
              </li>
            </ul>
          </div>
        ...
        <div id="opSystem" className="relative hidden h-screen top-20">
          <ul className="flex flex-row justify-between float-right w-full text-base font-semibold cursor-pointer text-lavander">
            ...
            <li className="text-3xl hover:text-bluebell" onClick={closeDropdown}>x</li>
          </ul>
        </div>
      </div>
    </div>
